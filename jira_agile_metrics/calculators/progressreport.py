                ...
                template.render(
                    ...
                    team_charts={
                        team.name: {
                            ...
                            "scatterplot": plot_scatterplot(
                                team.throughput_samples_cycle_times, quantiles
                            ),
                        }
                    ...
                    epic_charts={
                        epic.key: {
                            ...
                            "scatterplot": plot_scatterplot(
                                epic.story_cycle_times, quantiles
                            ),
                        }
                        for outcome in data["outcomes"]
                        for epic in outcome.epics
...
def update_story_counts(
    ...
    started_column = cycle[backlog_column_index + 1][
        "name"
    ...
    if epic.stories_raised == 0:
        ...
        epic.stories_in_progress = (
            story_cycle_times[started_column].count() - epic.stories_done
        )
        ...
        epic.first_story_started = (
            story_cycle_times[started_column].min().date()
...
def plot_cfd(
    cycle_data, cycle_names, backlog_column, target=None, deadline=None
):
    # Prepare data
...
def plot_throughput(cycle_data, frequency="1W"):
    ...
    plt.xticks(
        ...
        [d.date().strftime("%d/%m/%Y") for d in throughput_data.index],
        rotation=70,
        size="small",
    )
